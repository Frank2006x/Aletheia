    ...
    <div className="w-full h-full flex flex-col bg-[#050505]">
      <Card className="flex-1 flex flex-col overflow-hidden border-0 bg-transparent rounded-none">
        ...
        <div className="px-4 py-3 border-b border-white/[0.08] bg-black/40 flex-shrink-0">
          ...
          <p className="text-xs text-white/40 mt-0.5 pl-6">
            Ask anything about your report
          </p>
        </div>

        <CardContent className="flex-1 overflow-y-auto p-4 space-y-4 scrollbar-thin" data-lenis-prevent>
          {messages.length === 0 && (
            <div className="text-center mt-12 px-4">
              ...
              <p className="text-white/30 text-xs mt-2 leading-relaxed">
                Try: &quot;What are the key metrics?&quot; or &quot;Create a
                chart of emissions data&quot;
              </p>
              {/* Quick suggestions */}
              <div className="mt-6 flex flex-col gap-2">
                {[
                  "Summarize key ESG metrics",
