    ...
    <div className="grid grid-cols-2 gap-4 p-4 bg-[#050505]">
        ...
        >
          ...
          {chartWithInsight.insight && (
            <div className="flex items-start gap-2 pt-1 border-t border-white/[0.06]">
              ...
              <p className="text-xs text-white/50 italic">{chartWithInsight.insight}</p>
            </div>
          )}
        </Card>
      ))}
      ...
      <Card className="p-6 bg-[#0a0a0a] border border-primary/20 flex flex-col">
        <div className="flex items-center gap-2 mb-4 pb-3 border-b border-white/[0.06]">
          ...
          <span className="text-xs font-medium text-white/50 uppercase tracking-wider">ESG Score</span>
        </div>
        <div className="flex-1 flex flex-col justify-center space-y-4">
          <div className="flex items-end gap-3">
            <span className="text-6xl font-bold text-primary tabular-nums">{esgScore}</span>
      ...
      <Card className="p-6 bg-[#0a0a0a] border border-white/[0.08] flex flex-col">
        <div className="flex items-center gap-2 mb-4 pb-3 border-b border-white/[0.06]">
          ...
          <span className="text-xs font-medium text-white/50 uppercase tracking-wider">Improvements</span>
        </div>
      ...
      <Card className="p-6 bg-[#0a0a0a] border border-white/[0.08] flex flex-col">
        <div className="flex items-center gap-2 mb-4 pb-3 border-b border-white/[0.06]">
          ...
          <span className="text-xs font-medium text-white/50 uppercase tracking-wider">Merits</span>
        </div>
        <div className="space-y-2 max-h-44 overflow-y-auto">
      ...
      <Card className="p-6 bg-[#0a0a0a] border border-white/[0.08] flex flex-col col-span-2">
        <div className="flex items-center gap-2 mb-4 pb-3 border-b border-white/[0.06]">
          ...
          <span className="text-xs font-medium text-white/50 uppercase tracking-wider">GRI Standards Coverage</span>
        </div>
          ...
          {reportAnalysis.griCompliance.missingStandards.length > 0 && (
            <div>
              <div className="flex items-center gap-1.5 mb-3">
                ...
                <h4 className="text-xs font-semibold text-orange-400 uppercase tracking-wider">Missing</h4>
              </div>
          ...
          {reportAnalysis.griCompliance.coveredStandards.length > 0 && (
            <div>
              <div className="flex items-center gap-1.5 mb-3">
                ...
                <h4 className="text-xs font-semibold text-primary uppercase tracking-wider">Covered</h4>
              </div>
              <div className="flex flex-wrap gap-1.5">
