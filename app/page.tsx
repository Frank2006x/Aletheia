  ...
  return (
    <>
      ...
      <main className="bg-[#050505]">
        ...
        <section
          id="value-created"
          className="relative w-full h-screen overflow-hidden flex flex-col justify-end bg-black"
        >
          {/* Background video */}
          <video
            src="/ball.mp4"
            ...
            <div className="flex flex-col md:flex-row gap-6 w-full max-w-4xl">
              ...
              <div className="flex-1 bg-white/[0.03] border border-white/10 backdrop-blur-xl rounded-3xl p-8 hover:bg-white/[0.06] transition-all duration-500">
                ...
                <p className="text-white/60 leading-relaxed text-[15px]">
                  No technical integration or manual data entry. Upload your
                  existing ESG report or statements once, and our AI does the
                  rest. Gain instant access to the same analytics the investors
                  see, and use conversational AI to understand how your metrics
              ...
              <div className="flex-1 bg-white/[0.03] border border-white/10 backdrop-blur-xl rounded-3xl p-8 hover:bg-white/[0.06] transition-all duration-500">
                ...
                <p className="text-white/60 leading-relaxed text-[15px]">
                  Eliminate greenwashing. Every data point is cryptographically
                  anchored to the blockchain, creating a fully transparent and
                  immutable audit trail. Instantly query thousands of supplier
                  submissions with AI to surface risks and track scope emissions
